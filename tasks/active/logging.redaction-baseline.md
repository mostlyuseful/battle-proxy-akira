...
- [ ] Ensure Authorization headers and upstream tokens are never logged.
- [ ] Review request logging and provider error paths for accidental secret inclusion.
- [ ] Add redaction helpers for future structured records.
- [ ] Add tests proving bearer tokens and API keys do not appear in log output for representative failures.
